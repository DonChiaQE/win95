...
<template>
  <interact
    ...
    :style="style"
    @dragmove="dragmove"
    :class="{ fullscreen: $store.getters.isFullscreenColorization }"
  >
    <div
      class="about-me"
      id="container"
      :class="{
        fullscreen: $store.getters.isFullscreenColorization,
        close: !$store.getters.isShownColorization,
      }"
    >
      ...
      <div class="content">
        <div class="scroll-container">
          <div class="header">Colorization</div>
          <div
            class="square-container"
            :class="{ gridFullscreen: $store.getters.isFullscreenColorization }"
          >
            <div
              class="square"
              :class="{
                squareFullscreen: $store.getters.isFullscreenColorization,
              }"
              v-for="i in 10"
              v-bind:key="i"
            ...
            >
              <img
                ...
                :src="require(`../assets/Colorization/Colorization${i}.webp`)"
                :href="require(`../assets/Colorization/Colorization${i}.webp`)"
              />
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    closeColorization(e) {
      e.stopPropagation();
      this.$store.commit("toggleShownColorization", false);

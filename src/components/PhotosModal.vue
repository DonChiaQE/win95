...
<template>
  <interact
    ...
    :style="style"
    @dragmove="dragmove"
    :class="{ fullscreen: $store.getters.isFullscreenPhotos }"
  >
    <div
      class="window"
      id="container"
      :class="{
        fullscreen: $store.getters.isFullscreenPhotos,
        close: !$store.getters.isShownPhotos,
      }"
    >
      <div
        class="top-bar"
        id="top-bar"
        v-on:dblclick="$store.commit('toggleFullscreenPhotos')"
        :class="
          $store.getters.activeWindow == 'Photos'
            ? 'top-bar'
            : 'top-bar-deactivated'
        "
      >
        <div
          ...
          "
        >
          <img class="icon-image" src="../assets/win95Icons/photos.png" />Photos
        </div>
        <div class="triple-button">
          <div class="button-hide" v-on:click="minimizePhotos">
            <span
              style="
                height: 2px;
                width: 6px;
          ...
          <div
            class="button-expand"
            v-on:click="$store.commit('toggleFullscreenPhotos')"
          >
            <span
              style="
                height: 8px;
      ...
      <div class="content">
        <div class="scroll-container">
          <!-- change to photo container from diego website -->
